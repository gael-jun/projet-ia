<?php
    require_once('connect.php');
        $id = $_GET['id_regles'];
        $selSql = "SELECT *FROM `regles` WHERE id_regles='$id' ";
        ...
        if(isset($_POST['envoyer'])){
           ...
           if(isset($lib) && $lib != "" ){
                       ...
                       $resultat ="UPDATE `regles` SET libelle_regles='$libe' WHERE id_regles= '$id' ";
                                ...
                                <div class="p-4">
                                    <form class="user" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group row ">  
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="libelle" class="form-control form-control-user" style="font-size:18px;color:black;" value="<?php echo $r['libelle_regles']?>">
                                            </div>
                                        </div>
